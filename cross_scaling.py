...
REF = np.load(os.path.join(S.OUT_DIR, 'ref2d_cross.npz'))
...
print("\n--- CROSS-DIPOLE: resonance-region err (N=36) and k [95% CI] ---")
for s in strategies:
...
np.savez(os.path.join(S.OUT_DIR, 'cross_scaling.npz'), **save)
