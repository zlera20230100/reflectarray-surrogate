...
um,us=mstat(sc['uniform_res']); rm,rs=mstat(sc['random_res']); am,as_=mstat(sc['resaware_res'])
kr=sc['k_res_resaware']; ku=sc['k_res_uniform']; kk=sc['k_res_random']
...
ax.set_title(r'Data efficiency (6 seeds, mean$\pm$std)',fontsize=11,fontweight='bold')
