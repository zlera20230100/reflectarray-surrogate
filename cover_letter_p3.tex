...
We submit our manuscript, ``Resonance-Aware Active Sampling for Data-Efficient Differentiable Surrogates
of Resonant Responses: A Reflectarray Unit-Cell Case Study,'' for consideration as a research article.
...
a \emph{resonance-aware active-learning acquisition} that places samples by a curvature criterion
in a fully \emph{online} form that scores candidates using only already-acquired data---no
...
modelling (LOLA--Voronoi, $\sim$9$\times$), because those space-fill whereas a resonant response rewards
